...
\todo[inline]{Skripte u ljusci? Bash skripte? Ili samo skripte?}

%\subsection*{Što su shell skripte i čemu služe?}

\todo[inline]{Uvod cemo malo proširiti/preraditi. U komentaru je par novih misli.}

% Kombinacije naredbi koje se često ponavljaju prilikom rada u ljusci mogu se upisati u posebno pripremljene datoteke koje zovemo skripta. Na taj način može se automatizirati uobičajene radnje i učiniti rad na računalu bržim i efikasnijim. Skripte se koriste kod administracije računala, ... Skripta je u osnovi datoteka s nizom naredbi i parametara, koje se izvršavaju na isti način kao što bi se izvršile da su upisane izravno u terminalu. U Linuxu se mogu koristiti razne ljuske, a većina njih ima podršku za varijable, petlje, uvjetna grananja i slično. Danas se najviše koriste ljuske Bash i Bourne (?).
...
\todo[inline]{Ovo treba pregledati i možda ubaciti neke primjere kao prilog u skripti, mislim da je to bolje nego vanjski linkovi}
...
\todo[inline] {Ovo trebamo dobro rastrest i prevest na hrvatski (strong i weak, wildcardovi i slično). }
